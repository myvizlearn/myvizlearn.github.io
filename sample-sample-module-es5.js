...
var SamplePage = /** @class */ (function () {
    function SamplePage(_angularFireStore, _angularFireAuth) {
    ...
    SamplePage.prototype.ngOnInit = function () {
        console.log(this.conceptMap);
    };
    SamplePage.prototype.setSampleMap = function () {
    ...
    SamplePage.ctorParameters = function () { return [
